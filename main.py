...
from vars import API_ID, API_HASH, BOT_TOKEN, OWNER, CREDIT, AUTH_USERS, CHANNEL_ID
...
photologo = 'https://te.legra.ph/file/159d3f9e2d57dd02db970.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://te.legra.ph/file/159d3f9e2d57dd02db970.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://te.legra.ph/file/159d3f9e2d57dd02db970.jpg'
photozip = 'https://te.legra.ph/file/159d3f9e2d57dd02db970.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/rosy_dosy_bot"),
            InlineKeyboardButton(text="🛠️ Join", url="https://t.me/jgckco"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [🦅Golden Eagle🦅](https://t.me/rosy_dosy_bot)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
...
async def txt_handler(bot: Client, m: Message):  
    ...
    await editable.edit("`🔹Enter Classplus Token For m3u8 𝐔𝐑𝐋\n🔹Please wait..10sec...⏳ for use default`")
    try:
        input5: Message = await bot.listen(editable.chat.id, timeout=10)
        raw_text5 = input5.text
        await input5.delete(True)
    except asyncio.TimeoutError:
        raw_text5 = 'WOTKING_CP_TOKEN'
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                headers = {'Host': 'api.classplusapp.com', 'x-access-token': f'{raw_text5}', 'user-agent': 'Mobile-Android', 'app-version': '1.4.37.1', 'api-version': '18', 'device-id': '5d0d17ac8b3c9f51', 'device-details': '2848b866799971ca_2848b8667a33216c_SDK-30', 'accept-encoding': 'gzip'}
                params = (('url', f'{url}'))
                ...
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url={url}', headers={'x-access-token': f'{raw_text5}'}).json()['url']
            
            elif 'media-cdn.classplusapp.com' in url or 'media-cdn-alisg.classplusapp.com' in url or 'media-cdn-a.classplusapp.com' in url: 
                headers = { 'x-access-token': f'{raw_text5}',"X-CDN-Tag": "empty"}
